...
| `data/novel_eval/sft_zh_unsloth/train_cli.jsonl` | 命令行 train/eval 独立切分 | CLI SFT 训练输入 |
| `data/novel_eval/sft_zh_unsloth/eval.jsonl` | 命令行 train/eval 独立切分 | CLI SFT eval loss 监控 |
...
- `data/novel_eval/sft_zh_unsloth/train_cli.jsonl`，用于命令行 train/eval 切分后的训练
- `data/novel_eval/sft_zh_unsloth/eval.jsonl`，用于命令行 eval loss 和补充数据验证
