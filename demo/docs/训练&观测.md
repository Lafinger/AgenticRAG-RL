...
uv run python `
  ...
  --output-dir ./training/outputs/unsloth_sft_qwen3_4b_lora_react_v3 `
  --checkpoint ./training/outputs/unsloth_sft_qwen3_4b_lora_react_v3/checkpoint-495 `
  --dry-run
```
...
uv run python `
  ...
  --trace ./training/outputs/unsloth_sft_qwen3_4b_lora_react_v3_trace `
  --step 735
```
...
uv run --no-sync python `
  ./scripts/export_unsloth_lora.py `
  --config ./training/unsloth_sft.yaml `
  --adapter-path ./training/outputs/unsloth_sft_qwen3_4b_lora_react_v3/checkpoint-735 `
  --export-dir ./models/Qwen3-4B-Instruct-2507-Unsloth-SFT-react-v3-ckpt735-merged
```
