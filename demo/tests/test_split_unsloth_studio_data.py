...
from scripts.split_unsloth_studio_data import split_unsloth_studio_data
...
def test_split_unsloth_studio_data_writes_disjoint_files(tmp_path: Path) -> None:
    input_path = tmp_path / "train.jsonl"
    train_output = tmp_path / "train_studio.jsonl"
    ...
    assert manifest["studio_eval_disjoint_from_train"] is True
    assert manifest["studio_eval_count"] == 3
